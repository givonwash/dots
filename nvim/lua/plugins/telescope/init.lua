...
nmap('<localleader>fk', '<cmd>lua require("telescope.builtin").grep_string()<cr>')
...
nmap('<localleader>fs', '<cmd>lua require("telescope.builtin").lsp_document_symbols()<cr>')
nmap('<localleader>fv', '<cmd>lua require("telescope.builtin").vim_options()<cr>')
nmap('<localleader>fw', '<cmd>lua require("telescope.builtin").lsp_workspace_symbols()<cr>')
